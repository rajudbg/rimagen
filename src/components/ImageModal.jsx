    ...
    <AnimatePresence>
      {image && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8 bg-zinc-950/95 backdrop-blur-sm"
          onClick={onClose}
        >
          <motion.div
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-20 p-2.5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 text-zinc-300 transition-all hover:scale-110 border border-zinc-700/50"
            >
              ...
              {!isImageLoaded && (
                <div className="absolute inset-0 flex items-center justify-center bg-zinc-950 z-10">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-12 h-12 border-3 border-fuchsia-500/30 border-b-fuchsia-500 rounded-full animate-spin" style={{ animationDirection: 'reverse' }} />
                  </div>
                </div>
              )}
            ...
            <div className="p-5 border-t border-zinc-800/50 bg-zinc-900/50 backdrop-blur-sm space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold hover:from-violet-500 hover:to-fuchsia-500 transition-all hover:scale-105 flex items-center gap-2 text-sm shadow-lg shadow-violet-500/25"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
